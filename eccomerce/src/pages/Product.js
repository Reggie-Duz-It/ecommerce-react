...
const [modalIsOpen, setModalIsOpen] = useState(false);
  ...
  return ( 
   ...
   <article id='article2'>
      ...
      <Link to='/descending'><p id='dsclink'>Descending Order</p></Link>
      </div>
      </div>
      ...
      <Link to='/firstrow'><p id='firlink'>Volumes 1 - 3</p></Link>
      <Link to='/secondrow'><p id='seclink'>Volumes 4 - 6 </p></Link>
      <Link to='/thirdrow'><p id='thirlink'>Volumes 7 - 9</p></Link>
