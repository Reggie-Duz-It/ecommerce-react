...
const Fourthrow = () => {
  ...
  const fetchItems = async () => {
    const data = await fetch('/product/fourthrow');
...
const [modalIsOpen, setModalIsOpen] = useState(false);
  ...
  return ( 
   ...
   <article id='article2'>
      ...
      <span>Products Displayed:<Link to='/fourthrow'>Volumes 10 - 12</Link></span> 
      ...
      <Link to='/thirdrow'><p id='foulink'>Volumes 7 - 9</p></Link>
      </div>
      </div>
