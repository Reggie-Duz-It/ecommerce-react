...
const Ascending = () => {
  ...
  const fetchItems = async () => {
    const data = await fetch('/product/asc');
...
<div className='dropdown'>
      <span>Price Order By:<Link to='/ascending'>Ascending Order</Link></span> 
      <div class='dropdown-content'>
      <Link to='/descending'><p id='asclink'>Descending Order</p></Link>
